...
public class KalShow : MonoBehaviour {

	public UILabel kalShow;
	...
	void Update(){
		...
		float perKal = ss.GetSportItemPerMinuteKal (item);

		float sum = (float)m * perKal;

		kalShow.text = sum.ToString("f1");
	}
