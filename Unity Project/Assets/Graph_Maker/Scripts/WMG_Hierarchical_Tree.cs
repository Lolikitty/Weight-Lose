...
public class WMG_Hierarchical_Tree : WMG_Graph_Manager {
	...
	public void checkCache() {
		updateCacheAndFlagFloat(ref cachedGridLengthX, gridLengthX, ref treeChanged);
		updateCacheAndFlagFloat(ref cachedGridLengthY, gridLengthY, ref treeChanged);
		updateCacheAndFlagInt(ref cachedNodeWidthHeight, nodeWidthHeight, ref treeChanged);
		updateCacheAndFlagFloat(ref cachedNodeRadius, nodeRadius, ref treeChanged);
		updateCacheAndFlagBool(ref cachedSquareNodes, squareNodes, ref treeChanged);
	}
